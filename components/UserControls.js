...
const PlayerControls = ({songs}) => {
  const { currentSong, isPlaying, volume, onVolumeChange, timestamp, progress, playNext, playPrevious, isPaused, play, pause, onProgressChange } = useContext(PandoraContext)
...
const styles = {
  ...
  coverPhoto: `object-cover rounded-full`,
  mainControl: `fixed bottom-0 left-0 p-5 py-3 pr-10 w-screen bg-[#000018] z-40 flex items-center justify-between`,
